...
const RadarVisualization = ({
  ...
  useEffect(() => {
    ...
    const strokeColor = effectiveIsDark
      ? "rgba(255, 255, 255, 0.2)"
      : "rgba(0, 0, 0, 0.2)";
    const ringLabelColor = effectiveIsDark
    ...
    const quadrantColors = {
      Secure: "rgba(224, 175, 104, 0.2)",
      Maintain: "rgba(247, 118, 142, 0.2)",
      Save: "rgba(158, 206, 106, 0.2)",
      Scale: "rgba(122, 162, 247, 0.2)",
    };
    ...
    Object.entries(quadrantColors).forEach(([quadrant, color], index) => {
      ...
      const padding = 20;
      const quadrantLabelColor = effectiveIsDark
